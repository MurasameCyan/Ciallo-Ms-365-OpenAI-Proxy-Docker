...
def test_chat_stream_captures_asyncgw_media_signalr_event_for_debug(monkeypatch):
    captured = []
    event = {
        "type": 1,
        "target": "update",
        "arguments": [
            {
                "text": "https://jp-prod.asyncgw.teams.microsoft.com/v1/objects/0-ea-d1/views/original/tornado_sound.wav",
                "kind": "generatedAudio",
            }
        ],
    }
