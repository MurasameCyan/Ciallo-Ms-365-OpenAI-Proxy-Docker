...
_USER_I18N_JS = """const i18n={
  zh:{
    ...
    pkce_section_title:'浏览器登录',pkce_no_account:'尚未绑定账户，先推送一次 Token 或 Cookie 完成绑定后再来登录。',
  ...
  en:{
    ...
    pkce_section_title:'Browser sign-in',pkce_no_account:'No account is bound yet. Push a token or cookies once to bind one, then sign in here.',
