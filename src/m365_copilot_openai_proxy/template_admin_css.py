...
.side-update-bar{display:flex;align-items:center;gap:.35rem;width:100%;min-width:0}
.side-build-chip{display:inline-flex;align-items:center;justify-content:center;min-width:0;flex:1;height:32px;padding:0 .55rem;border-radius:12px;font-size:.68rem;font-weight:700;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-variant-numeric:tabular-nums;letter-spacing:.03em;color:var(--muted);background:linear-gradient(135deg,rgba(96,242,255,.1),rgba(140,107,255,.1));border:1px solid rgba(96,242,255,.22);box-shadow:inset 0 1px 0 rgba(255,255,255,.16);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.side-update-btn{display:inline-flex;align-items:center;justify-content:center;gap:.28rem;flex-shrink:0;height:32px;padding:0 .55rem;border-radius:12px;border:1px solid rgba(96,242,255,.22);background:linear-gradient(135deg,rgba(96,242,255,.12),rgba(140,107,255,.12));color:var(--muted);font-size:.68rem;font-weight:700;line-height:1;cursor:pointer;box-shadow:inset 0 1px 0 rgba(255,255,255,.16);transition:background .16s ease,color .16s ease,border-color .16s ease,opacity .16s ease}
.side-update-btn:hover{color:var(--text);background:linear-gradient(135deg,rgba(96,242,255,.22),rgba(255,94,219,.12));border-color:rgba(96,242,255,.4)}
...
.side-update-label{max-width:5.2rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
@keyframes sideSpin{to{transform:rotate(360deg)}}
.side-gh-ico{flex:0 0 auto;display:block;opacity:.92}
/* Tools row: 5 icon slots (collapse/theme/lang/repo/logout). */
.side-tools{position:relative;height:42px;padding-top:0;width:100%}
body[data-theme="light"] .side-build-chip{color:var(--muted);background:linear-gradient(135deg,rgba(255,255,255,.78),rgba(0,122,255,.08));border-color:rgba(0,122,255,.16);box-shadow:inset 0 1px 0 rgba(255,255,255,.9)}
body[data-theme="light"] .side-update-btn{color:var(--muted);background:linear-gradient(135deg,rgba(255,255,255,.78),rgba(0,122,255,.08));border-color:rgba(0,122,255,.16)}
body[data-theme="light"] .side-update-btn:hover{color:var(--text);border-color:rgba(0,122,255,.28)}
...
.side-tools .icon-btn:nth-child(2){transform:translate(36px,0)}
.side-tools .icon-btn:nth-child(3){transform:translate(72px,0)}
.side-tools .icon-btn:nth-child(4){transform:translate(108px,0)}
.side-tools .icon-btn:nth-child(5){transform:translate(144px,0)}
...
/* Collapsed: hide update bar; keep tool icons (incl. GitHub) stacked. */
body[data-collapsed="1"] .side-update-bar{display:none!important}
body[data-collapsed="1"] .side-footer{gap:0}
body[data-collapsed="1"] .side-tools{height:250px;padding-top:1rem}
...
body[data-collapsed="1"] .side-tools .icon-btn:nth-child(5){transform:translate(0,176px)}
