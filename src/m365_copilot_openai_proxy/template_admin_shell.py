...
<a class="side-version" id="side-version" href="__APP_GIT_URL__" target="_blank" rel="noopener noreferrer" title="GitHub __APP_GIT_FULL__">
...
<span class="side-hash" id="side-hash">__APP_GIT_HASH__</span>
</a>
