...
_ADMIN_I18N_JS = """const i18n={
  ...
  en:{
    ...
    batch_refresh:'Refresh',batch_delete:'Delete',batch_enable:'Enable',batch_disable:'Disable',batch_none:'Select items first',batch_confirm_delete:'Delete selected items?',
