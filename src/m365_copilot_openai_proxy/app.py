...
input:-webkit-autofill,input:-webkit-autofill:focus,input:-webkit-autofill:hover{-webkit-text-fill-color:var(--text)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.08)!important;-webkit-box-shadow:0 0 0 1000px rgba(7,11,27,.46) inset,inset 0 1px 0 rgba(255,255,255,.08)!important;caret-color:var(--text);transition:background-color 9999s ease-in-out 0s,color 9999s ease-in-out 0s}
...
function donut(parts,centerLabel,centerVal){
  ...
  if(total>0){
    parts.forEach(p=>{
      ...
      halo+='<circle cx="60" cy="60" r="'+(R+5)+'" fill="none" stroke="'+p.color+'" stroke-width="14" stroke-linecap="round" stroke-dasharray="'+len+' '+(C-len)+'" stroke-dashoffset="'+(-off)+'" transform="rotate(-90 60 60)" filter="url(#'+uid+'halo)" opacity="0.2"><animate attributeName="opacity" values="0.16;0.62;0.16" dur="5.5s" repeatCount="indefinite"/><animate attributeName="stroke-width" values="9;20;9" dur="5.5s" repeatCount="indefinite"/></circle>';
      halo+='<circle cx="60" cy="60" r="'+(R-8)+'" fill="none" stroke="'+p.color+'" stroke-width="1.6" stroke-linecap="round" stroke-dasharray="'+len+' '+(C-len)+'" stroke-dashoffset="'+(-off)+'" transform="rotate(-90 60 60)" filter="url(#'+uid+'halo)" opacity="0.16"><animate attributeName="opacity" values="0.08;0.28;0.08" dur="5.5s" repeatCount="indefinite"/><animate attributeName="stroke-width" values="1;2.6;1" dur="5.5s" repeatCount="indefinite"/></circle>';
      off+=len;
    });
  }
...
#login-card input:-webkit-autofill,#login-card input:-webkit-autofill:focus,#login-card input:-webkit-autofill:hover{-webkit-text-fill-color:#e2e8f0!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.08)!important;-webkit-box-shadow:0 0 0 1000px rgba(10,16,36,.46) inset,inset 0 1px 0 rgba(255,255,255,.08)!important;caret-color:#e2e8f0;transition:background-color 9999s ease-in-out 0s,color 9999s ease-in-out 0s}
