...
async function loadMe(){
  ...
  try{
    ...
    const consoleActions='<span style="display:inline-flex;gap:.35rem;margin-left:.2rem"><button class="btn-ghost account-action" title="'+t('change_password')+'" onclick="changeLoginPassword(this)" style="width:32px;height:28px;padding:0;font-size:1rem;line-height:1;background:rgba(250,204,21,.14);border-color:rgba(250,204,21,.38)">🔑</button><button class="btn-ghost account-action" title="'+t('console_logout')+'" onclick="logoutConsole()" style="width:32px;height:28px;padding:0;font-size:1rem;line-height:1;background:rgba(56,189,248,.14);border-color:rgba(56,189,248,.38)">🚪</button></span>';
    if(d.account){
