...
function donut(parts,centerLabel,centerVal){
  ...
  let svg='<svg viewBox="0 0 120 120" style="width:120px;height:120px;flex-shrink:0;overflow:visible;filter:drop-shadow(0 0 10px rgba(96,242,255,.22)) drop-shadow(0 0 18px rgba(140,107,255,.16))">'+defs+halo+ring+sheen
...
function lineChart(points,series){
  ...
  series.forEach(s=>{
    ...
    g+='<path d="'+d+'" fill="none" stroke="'+s.color+'" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" filter="drop-shadow(0 0 5px '+s.color+')"/>';
  });
